-- =====================================================================
-- Migration: 20260426_corpus_recaps.sql
-- Feature : 015-corpus-recaps
-- Purpose : Add page_captures table + extend recaps with mode column.
--           Reuses the existing recaps.page_snapshot column for delta
--           range bounds (no separate progress_snapshot_page needed).
-- =====================================================================
...
comment on column public.recaps.mode is
  'Generation path: ''corpus'' = generated from page_captures text; ''inferred'' = generated from book metadata + progress percentage. Historical rows default to ''inferred''.';
