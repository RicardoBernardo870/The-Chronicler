...
<template>
  <div class="great-library">
    ...
    <TabMenu v-model:activeIndex="activeIndex" :model="tabItems" class="great-library__tabmenu" />
    ...
    <div v-show="activeIndex === 0" class="great-library__panel">
      ...
      <!-- Empty state -->
      <div v-else-if="filteredLexiconEntries.length === 0" class="great-library__empty glass-surface">
